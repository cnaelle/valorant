 ...
 * Description: CoCart Pro completes the <strong>shopping experience</strong> with more powerful options and support for extensions.
 * Author:      Sébastien Dumont
 * Author URI:  https://sebastiendumont.com
 * Version:     1.0.0-rc.5
 * Text Domain: cocart-pro
...
if ( ! class_exists( 'CoCart_Pro' ) ) {
	class CoCart_Pro {
		 ...
		 * @static
		 */
		public static $version = '1.0.0-rc.5';
