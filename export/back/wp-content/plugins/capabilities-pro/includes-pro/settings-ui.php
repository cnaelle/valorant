...
class Pro_Settings_UI {
    ...
    public function licenseTab() {
        ?>
        <li class="nav-tab nav-tab-active"><a href="#ppcs-tab-general"><?php esc_html_e('License', 'capabilities-pro');?></a></li>
        <?php
    }
                ...
                <td>
                    <label for="" title="<?php esc_attr_e('Admin Menus: treatment of multiple roles', 'capabilities-pro');?>"> 
                        <select name="cme_admin_menus_restriction_priority" id="cme_admin_menus_restriction_priority" autocomplete="off">
                            <option value="0"<?php echo (esc_attr($checked)) ? '' : ' selected';?>>
                                <?php esc_html_e('Any non-restricted user role allows access', 'capabilities-pro');?>
                            </option>
                            <option value="1"<?php echo (esc_attr($checked)) ? ' selected' : '';?>>
                                <?php esc_html_e('Any restricted user role prevents access', 'capabilities-pro');?>
                            </option>
                        </select>
