...
if ( ! class_exists( 'CoCart_Pro_Admin' ) ) {
	...
	class CoCart_Pro_Admin {
		...
		public function __construct() {
			...
			// Licence Manager
			add_filter( 'cocart_page_title_licence_manager', function() { return sprintf( esc_attr__( 'Licence Manager for %s', 'cocart-pro' ), 'CoCart Pro' ); } );
			add_action( 'cocart_page_section_licence_manager', array( $this, 'licence_manager' ) );
