		...
		*/
		...
		function format_value($value, $post_id, $field)
		{
			...
			foreach ($value as $taxonomy) {
				$image_id = get_term_meta($taxonomy->term_id, 'thumbnail_id', true);
				$taxonomy->image = ['sizes' => [
					...
					'full_size' => wp_get_attachment_image_src($image_id, 'full_size')[0],
				]];
				$taxonomy->route = ['path' => parse_url(get_term_link($taxonomy))['path']];
			}
